...
options-tech-level =
    ...
    .low = Low
    .medium = Medium
    .no-superweapons = NoSuperweapons
...
label-mainmenu-prerelease-notification-prompt-title = Red Alert 2 developer preview
label-mainmenu-prerelease-notification-prompt-text-a = This pre-alpha build of OpenRA's Red Alert 2 mod is made available
